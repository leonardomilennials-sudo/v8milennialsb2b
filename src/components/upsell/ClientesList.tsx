...
import { Plus, Search, Users, TrendingUp, DollarSign, Building2, Edit, Eye, Upload } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-lg">Base de Clientes Ativos</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
